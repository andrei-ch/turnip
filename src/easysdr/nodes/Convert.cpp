...
template <>
inline constexpr short convert<uint8_t, short>(uint8_t sample) {
...
template <>
inline constexpr short convert<float, short>(float sample) {
...
static_assert(convert<uint8_t, short>(0) == -32768);
static_assert(convert<uint8_t, short>(64) == -16384);
static_assert(convert<uint8_t, short>(128) == 0);
static_assert(convert<uint8_t, short>(192) == 16384);
static_assert(convert<uint8_t, short>(255) == 32512);
...
static_assert(convert<short, uint8_t>(-32768) == 0);
static_assert(convert<short, uint8_t>(-16384) == 64);
static_assert(convert<short, uint8_t>(0) == 128);
static_assert(convert<short, uint8_t>(16384) == 192);
static_assert(convert<short, uint8_t>(32767) == 255);
static_assert(convert<short, float>(-32768) == -1.f);
static_assert(convert<short, float>(-16384) == -.5f);
static_assert(convert<short, float>(0) == 0.f);
static_assert(convert<short, float>(16384) == .5f);
static_assert(convert<short, float>(32767) == .9999694824f);
...
static_assert(convert<float, short>(-1.f) == -32767);
static_assert(convert<float, short>(-.5f) == -16383);
static_assert(convert<float, short>(0.f) == 0);
static_assert(convert<float, short>(.5f) == 16383);
static_assert(convert<float, short>(1.f) == 32767);
...
template class Convert<uint8_t, short>;
template class Convert<uint8_t, float>;
template class Convert<uint8_t, std::complex<float>>;
template class Convert<short, uint8_t>;
template class Convert<short, float>;
template class Convert<short, std::complex<float>>;
template class Convert<float, uint8_t>;
template class Convert<float, short>;
template class Convert<float, std::complex<float>>;
template class Convert<std::complex<float>, uint8_t>;
template class Convert<std::complex<float>, short>;
